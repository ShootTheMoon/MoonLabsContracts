...
contract MoonLabsTokenLockerAlt is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  using SafeERC20Upgradeable for IERC20Upgradeable;

  function initialize(address _feeCollector, address _burnCollector, address referralAddress, address whitelistAddress, address routerAddress) public initializer {
    __Ownable_init();
  ...
  uint public burnThreshold; /// ETH in WEI when ETH should be set to burn handler wallet
  uint public burnMeter; /// Current ETH in WEI for the burn wallet

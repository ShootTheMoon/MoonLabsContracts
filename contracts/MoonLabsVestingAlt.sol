...
contract MoonLabsVestingAlt is Initializable, OwnableUpgradeable, ReentrancyGuardUpgradeable {
  using SafeERC20Upgradeable for IERC20Upgradeable;

  function initialize( address _feeCollector, address referralAddress, address _burnCollector, address whitelistAddress, address routerAddress) public initializer {
    __Ownable_init();

...
contract MoonLabsWhitelistAlt is Initializable, IMoonLabsWhitelist, OwnableUpgradeable {
  ...
  function initialize(address _feeCollector, address referralAddress, address usdAddress, uint _costUSD) public initializer {
    __Ownable_init();
   ...
   */
  function getIsWhitelisted(address _address, bool pair) public view override returns (bool) {
